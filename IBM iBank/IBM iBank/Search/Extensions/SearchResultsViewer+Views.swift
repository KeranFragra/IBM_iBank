//
//  SearchResultsViewer+Views.swift
//  IBM iBank
//
...
extension SearchResultsViewer {
    
    func setupMainButton() {
        mainButton.translatesAutoresizingMaskIntoConstraints = false
        mainButton.setTitle("GO TO HOME", for: .normal)
    ...
    func setupCollectionView() {
        ...
        activate(constraint: collectionView.bottomAnchor.constraint(equalTo: mainButton.topAnchor, constant: -15))
        ...
        //
        collectionView.register(SearchResultsMainCell.self, forCellWithReuseIdentifier: SearchResultsMainCell.identifier)
        collectionView.register(BaseUICollectioViewCell.self, forCellWithReuseIdentifier: BaseUICollectioViewCell.identifier)
        collectionView.register(SearchItemHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: SearchItemHeaderView.identifier)
    }
}
